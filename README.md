...
## Environments
- Preview: https://main--instructor-temp--lab339.hlx.page/
- Live: https://main--instructor-temp--lab339.hlx.live/
...
1. Open the `instructor-temp` directory in your favorite IDE and start coding :)
